...
export const FORM_MESSAGES = {
	...
	SOCIAL_LOGIN_SUCCESS: (provider: SocialProvider) =>
		`Logged in with ${SOCIAL_PROVIDER_LABELS[provider]}!`,
	SOCIAL_REGISTER_SUCCESS: (provider: SocialProvider) =>
		`Signed up with ${SOCIAL_PROVIDER_LABELS[provider]}!`,
	...
	CHANGING: "Changing...",
	RESETTING: "Resetting...",
	SIGN_IN_WITH: (provider: SocialProvider) =>
		`Sign in with ${SOCIAL_PROVIDER_LABELS[provider]}`,
	SIGN_UP_WITH: (provider: SocialProvider) =>
		`Sign up with ${SOCIAL_PROVIDER_LABELS[provider]}`,
...
export const CARD_CLASSES =
	"w-full max-w-2xl shadow-2xl border-slate-200 dark:border-slate-800";
export const BUTTON_PRIMARY_CLASSES =
	"w-full h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg transition-all duration-200";
export const BUTTON_OUTLINE_CLASSES =
	"h-11 hover:bg-slate-100 dark:hover:bg-slate-800";
